...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "row-span-1 relative overflow-hidden rounded-3xl border-none group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none justify-between flex flex-col space-y-4",
        className
      )}
      style={{
    ...
    >
      <div
        className={`${id === 6 && "flex justify-center"} bg-black-200 h-full`}
      >
